...
export const metadata = {
  title: "Frequently Asked Questions | Childcare Training Programs",
  description:
    "Find answers to common questions about our childcare training programs, certifications, and professional development services at BlueSky Training & Development.",
}
