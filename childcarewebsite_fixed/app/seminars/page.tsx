...
export const metadata = {
  title: "Seminars & Events | Online Childcare Training Workshops",
  description:
    "Join our upcoming virtual seminars and professional development events for childcare providers. Enhance your skills with expert-led workshops and training sessions.",
}
      ...
      <div className="container mx-auto px-4">
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Event",
            name: "CDA Information Session",
            description:
              "Comprehensive virtual information session about the Child Development Associate (CDA) credential",
            startDate: "2025-02-24T17:00:00-05:00",
            endDate: "2025-02-24T18:30:00-05:00",
            eventAttendanceMode: "https://schema.org/OnlineEventAttendanceMode",
            eventStatus: "https://schema.org/EventScheduled",
            location: {
              "@type": "VirtualLocation",
              url: "https://www.blueskytd.com/virtual-event",
            },
            organizer: {
              "@type": "Organization",
            ...
            offers: {
              ...
              url: "https://www.blueskytd.com/register",
            },
          })}
        </script>
      </div>
