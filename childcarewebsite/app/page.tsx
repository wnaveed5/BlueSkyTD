export const metadata = {
  title: "Home | Professional Childcare Training & Development",
  description:
    "BlueSky Training & Development offers expert childcare provider education, workshops, and consulting services. Enhance your skills and advance your career in early childhood education.",
}
    ...
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                Professional Childcare Training for a <span className="text-sky-600">Brighter Tomorrow</span>
              </h1>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description: "Professional childcare training and development services",
          url: "https://www.blueskytd.com",
          logo: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/In-Line%20logo%20with%20Website-FULL%20COLOR-IXFiwVR6jRR3NID35rdncYpVY5yICM.png",
          sameAs: [
          ...
          telephone: "+1-281-980-8888",
          email: "info@blueskytd.com",
        })}
      </script>
    </>
  )
