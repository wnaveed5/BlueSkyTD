export const metadata = {
  title: "Register for Virtual Events | Childcare Training Seminars",
  description:
    "Sign up for our upcoming virtual childcare training events and seminars. Enhance your skills and knowledge in early childhood education from the comfort of your home.",
}
;("use client")
